...
Board *GetFromFile()
{
    ...
    Board *board = new Board(Board_File_X, Board_File_Y);
    ...
    while(!file.eof())       //wczytywanie kolejnych pol
    {
        ...
        for(; line[iterator] != ','; iterator++)
        {
            HP_File = HP_File * 10 + line[iterator] - '0';
            //iterator++;
        }
        ...
        for(; line[iterator] != ';'; iterator++)
        {
            Dmg_File = Dmg_File * 10 + line[iterator] - '0';
            //iterator++;
        }
